                  ...
                  <table className="w-full table-fixed">
                    <thead className="sticky top-0">
                      <tr>
                        ...
                        <th className="border-b p-2 text-left hover:cursor-pointer hover:bg-gray-200"
                          onClick={() => handleOrderbyChange("locatarios.0.pessoa.telefone")}
                        >
                          <div className="flex items-center">
                            <span>Telefone&nbsp;&nbsp;</span> {sortField === "locatarios.0.pessoa.telefone" ? (order === "asc" ? <ArrowDownNarrowWide size={"16"} /> : <ArrowDownWideNarrow size={"16"} />) : <></>}
                          </div>
                        </th>
                        <th className="border-b p-2 text-left hover:cursor-pointer hover:bg-gray-200"
                          onClick={() => handleOrderbyChange("locatarios.0.pessoa.documento")}
                        >
                          <div className="flex items-center">
                            <span>Documento&nbsp;&nbsp;</span> {sortField === "locatarios.0.pessoa.documento" ? (order === "asc" ? <ArrowDownNarrowWide size={"16"} /> : <ArrowDownWideNarrow size={"16"} />) : <></>}
                          </div>
                        </th>
                        <th className="border-b p-2 text-left hover:cursor-pointer hover:bg-gray-200"
                          onClick={() => handleOrderbyChange("locatarios.0.pessoa.email")}
                        >
                          <div className="flex items-center">
                            <span>Email&nbsp;&nbsp;</span> {sortField === "locatarios.0.pessoa.email" ? (order === "asc" ? <ArrowDownNarrowWide size={"16"} /> : <ArrowDownWideNarrow size={"16"} />) : <></>}
                          </div>
                        </th>
